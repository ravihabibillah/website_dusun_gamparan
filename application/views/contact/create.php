		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins p-2">
				<div class="ibox-title">
					<h3 class="font-weight-bold">Tambah Kontak</h3>
				</div>
				...
				<div class="ibox-content" style="padding: 5em 3em;">
					<form method="post" class="form-horizontal" action="">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="name" class="form-control name" placeholder="Nama">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="telp" class="form-control telp" placeholder="085700752966">
						...
						<div class="form-group m-r-xl m-t-sm" style="float: right">
							<a href="<?= base_url(); ?>admin/contact" class="btn btn-white"><i class="fa fa-chevron-left"></i> Kembali</a>
